...
static void gui_menu_draw_background(gui_menu_t* menu)
{
    ...
    if (!render_custom_title(menu->custom_gui)) 
    {
        ...
        gfx_printf(&g_gfx_con, "Kiminonawa v%d.%d", MAJOR_VERSION, MINOR_VERSION);
		
	gfx_con_setpos(&g_gfx_con, 1000, 10);
	gfx_printf(&g_gfx_con, "Powered by argon");
